...
function buildPickerSystemPrompt(
  ...
  const lines: string[] = [
    ...
    'RULE: Match the source\'s level of specificity and emotion across ALL contexts. Vague source = vague translation. Don\'t fill in details, subjects, objects, consequences, threats, or context the speaker didn\'t explicitly provide.',
    'In conflict especially: Do NOT interpret "can\'t" as "won\'t", "don\'t understand" as "refuse to understand", or neutral statements as threats/ultimatums.',
    '',
