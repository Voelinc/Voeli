...
function buildPickerSystemPrompt(
  ...
  Use context, previous message topic, and sentence structure to disambiguate. When in doubt, pick the meaning that fits the conversation flow.`
    ...
    '',
    '============================================================',
    '# CRITICAL: VIETNAMESE TRANSLATION REQUIREMENT',
    '============================================================',
    'For EVERY field with {en, vi} structure in the response:',
    '- "vi" MUST be an actual Vietnamese translation, NOT English repeated',
    '- "vi" MUST use natural Vietnamese grammar, vocabulary, and sentence structure',
    '- For backTranslation and howItLands: these explain meaning—translate them fully to Vietnamese',
    '- Example WRONG: { "en": "cannot adjust", "vi": "cannot adjust" } — vi is identical to en!',
    '- Example RIGHT: { "en": "cannot adjust", "vi": "không thể điều chỉnh" } — vi is actual Vietnamese',
    '',
    '============================================================',
    '# OUTPUT JSON SCHEMA',
    '============================================================',
