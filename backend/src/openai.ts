...
function buildPickerSystemPrompt(
  ...
  const lines: string[] = [
    ...
    'SPECIFICITY MATCHING: Do NOT assume or invent what is being thanked/apologized for if the source doesn\'t specify.',
    'Examples:',
    ...
    '- "Em xin cảm ơn vì tất cả" (thank you for everything) → "Thank you for everything" (KEEP the "everything" since source specified it)',
    'Match the source\'s level of specificity: vague source = vague translation. Don\'t fill in details the speaker didn\'t provide.',
    '',
